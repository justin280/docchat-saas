...
export const metadata = {
    title: 'AI for Healthcare Research | DocChat AI',
    description: 'DocChat AI for healthcare professionals. Process clinical studies, medical literature and research documents with AI.',
    ...
    return (
      ...
      <NavBar activePath="/healthcare" />
        ...
        <h1 style={{fontSize:'clamp(24px,4vw,40px)',fontWeight:'700',margin:'32px 0 16px'}}>AI for <span style={{color:'#84cc16'}}>Healthcare Research</span></h1>
          <h2 style={{fontSize:'18px',color:'#9ca3af',fontWeight:'400',marginBottom:'32px'}}>Process clinical studies, medical literature and healthcare documents with AI — powered by NVIDIA NIM</h2>
        <p style={{color:'#d1d5db',lineHeight:'1.8',marginBottom:'20px'}}>Healthcare professionals and researchers use DocChat AI to process volumes of clinical literature that would take days to review manually. Upload multiple research papers, clinical guidelines or medical device manuals and ask questions across all of them simultaneously.</p>
        <p style={{color:'#d1d5db',lineHeight:'1.8',marginBottom:'20px'}}>Documents are processed in-session only and never stored. All communications are TLS-encrypted.</p>
